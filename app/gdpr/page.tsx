    ...
    <section style={{ backgroundColor: "#F7F5F0", padding: "120px 48px 80px", minHeight: "100vh" }} className="px-6 md:px-[48px]">
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        {[
          ...
          "Данните, предоставени чрез контактната форма (име, имейл, телефон), се използват единствено за отговор на вашето запитване и не се предоставят на трети страни.",
